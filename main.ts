...
controller.A.onEvent(ControllerButtonEvent.Released, function () {
    ...
    if (player_pos > 0) {
        player_pos += -1
        console.logValue("change player_pos by", -1)
    }
    console.log("A button successful")
})
controller.B.onEvent(ControllerButtonEvent.Released, function () {
    ...
    if (player_pos < 3) {
        player_pos += 1
        console.logValue("change player_pos by", 1)
        console.log("B button successful")
    }
})
let car: Sprite = null
...
game.showLongText("Welcome to Duck Dodge!", DialogLayout.Center)
game.showLongText("use A to go up and use B to go down a lane.", DialogLayout.Bottom)
info.setScore(0)
player_pos = 0
console.logValue("player_pos", 0)
...
console.log("lane_positions is a list of the y positions of all the lanes")
duck = sprites.create(img`
    ...
    . . . c c c c c c c c b b . . . 
    `, SpriteKind.Player)
let car_spawner = sprites.create(img`
    . . . . . . . . . . . . . . . . 
    . . . . . . . . . . . . . . . . 
    . . . . . . . . . . . . . . . . 
    . . . . . . . . . . . . . . . . 
    ...
    . . . . . . . . . . . . . . . . 
    `, SpriteKind.Enemy)
console.log("the duck and the car spawner have been set")
scene.setBackgroundImage(img`
    ...
    bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb
    `)
console.log("background image has been set")
duck.x = 30
console.logValue("duck.x", 30)
car_spawner.x = 160
console.logValue("car_spawner.x", 160)
game.onUpdateInterval(1000, function () {
    info.changeScoreBy(1)
})
// spawn cars with a random vx at a random interval
forever(function () {
    car = sprites.createProjectileFromSprite(img`
        . . . . . . . 8 8 8 8 8 . . . . 
        . . . . . 8 8 6 6 6 6 6 8 . . . 
        . . . . 8 8 6 6 6 6 6 6 6 8 . . 
